...
> = {
  ...
  warning: { Icon: ArrowDownRight, className: "bg-amber-500/15 text-amber-600" },
    ...
    <Card className="flex h-full min-h-0 flex-col gap-0 overflow-hidden py-0 ring-inset">
      <CardHeader className="border-b border-border px-3 py-3">
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-sm md:text-base">هشدارهای فعال من</CardTitle>
        </div>
      </CardHeader>
          ...
          {MY_ALERTS.map((alert) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={cn("size-2 shrink-0 rounded-full", DOT[alert.tone])}
                  aria-hidden
                />
              </li>
            )
